            ...
            <div class="footer-content">
              <div class="footer-head">
                ...
                <div class="footer-contacts">
                  <p><span>Tel:</span> +123 456 0945 </p>
                  <p><span>Email:</span> clean@support.com</p>
                  <p><span>Location:</span> 42-A4 Road, Avanue, Londan.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="copyright">
              <p>
                Copyright © 2020
                <a href="#">CLEAN SERVICE</a> All Rights Reserved
              </p>
            </div>
          </div>
        </div>
